...
// Library: 21 scenarios, all universal tier — ~3 weeks of daily Maps without
...
var Scenarios = []Scenario{
	...
	{
		ScenarioID:        "unrepayable_favor_016",
		Type:              ScenarioMoral,
		Tier:              TierUniversal,
		Text:              "Someone helped you once in a way you could never repay. Lately they've started asking for things.",
		DimensionAffinity: []string{"agreeableness", "grim_trigger", "k_level"},
		NodePool: []ScenarioNode{
			{NodeID: "the_original_debt", Text: "the original debt", PrimaryDimension: "temporal_focus", DimensionSignals: map[string]NodeDimSignal{"temporal_focus": {Direction: "past"}, "conscientiousness": {Direction: "high"}}},
			{NodeID: "what_counts_as_even", Text: "what would count as even", PrimaryDimension: "k_level", DimensionSignals: map[string]NodeDimSignal{"k_level": {Direction: "high"}, "conscientiousness": {Direction: "high"}}},
			{NodeID: "the_first_no", Text: "the first no", PrimaryDimension: "approach_avoidance", DimensionSignals: map[string]NodeDimSignal{"approach_avoidance": {Direction: "high"}, "agreeableness": {Direction: "low"}}},
			{NodeID: "their_memory_of_it", Text: "their memory of it", PrimaryDimension: "agreeableness", DimensionSignals: map[string]NodeDimSignal{"agreeableness": {Direction: "high"}, "locus_of_control": {Direction: "external"}}},
			{NodeID: "the_running_tally", Text: "the running tally", PrimaryDimension: "grim_trigger", DimensionSignals: map[string]NodeDimSignal{"grim_trigger": {Direction: "high"}, "conscientiousness": {Direction: "high"}}},
			{NodeID: "who_keeps_score", Text: "who keeps score here", PrimaryDimension: "k_level", DimensionSignals: map[string]NodeDimSignal{"k_level": {Direction: "high"}, "agreeableness": {Direction: "low"}}},
			{NodeID: "the_thing_they_gave", Text: "the thing they gave", PrimaryDimension: "discount_factor", DimensionSignals: map[string]NodeDimSignal{"discount_factor": {Direction: "low"}, "temporal_focus": {Direction: "past"}}},
			{NodeID: "saying_yes_again", Text: "saying yes again", PrimaryDimension: "approach_avoidance", DimensionSignals: map[string]NodeDimSignal{"approach_avoidance": {Direction: "low"}, "agreeableness": {Direction: "high"}}},
			{NodeID: "the_clean_break", Text: "the clean break", PrimaryDimension: "grim_trigger", DimensionSignals: map[string]NodeDimSignal{"grim_trigger": {Direction: "high"}, "approach_avoidance": {Direction: "high"}}},
			{NodeID: "what_gratitude_owes", Text: "what gratitude owes", PrimaryDimension: "agreeableness", DimensionSignals: map[string]NodeDimSignal{"agreeableness": {Direction: "high"}, "k_level": {Direction: "high"}}},
			{NodeID: "the_quiet_resentment", Text: "the quiet resentment", PrimaryDimension: "neuroticism", DimensionSignals: map[string]NodeDimSignal{"neuroticism": {Direction: "high"}, "approach_avoidance": {Direction: "low"}}},
			{NodeID: "whether_it_was_a_gift", Text: "whether it was ever a gift", PrimaryDimension: "openness", DimensionSignals: map[string]NodeDimSignal{"openness": {Direction: "high"}, "locus_of_control": {Direction: "internal"}}},
		},
	},
	{
		ScenarioID:        "challenger_cold_017",
		Type:              ScenarioHistorical,
		Tier:              TierUniversal,
		Text:              "January 1986. The morning is colder than the rules allow. You're the engineer who flagged the O-rings. The launch is still go.",
		DimensionAffinity: []string{"conscientiousness", "locus_of_control", "grim_trigger"},
		NodePool: []ScenarioNode{
			{NodeID: "the_memo_you_sent", Text: "the memo you already sent", PrimaryDimension: "conscientiousness", DimensionSignals: map[string]NodeDimSignal{"conscientiousness": {Direction: "high"}, "temporal_focus": {Direction: "past"}}},
			{NodeID: "the_room_that_overruled", Text: "the room that overruled you", PrimaryDimension: "locus_of_control", DimensionSignals: map[string]NodeDimSignal{"locus_of_control": {Direction: "external"}, "agreeableness": {Direction: "high"}}},
			{NodeID: "the_phone_you_could_lift", Text: "the phone you could still lift", PrimaryDimension: "approach_avoidance", DimensionSignals: map[string]NodeDimSignal{"approach_avoidance": {Direction: "high"}, "neuroticism": {Direction: "high"}}},
			{NodeID: "what_you_can_prove", Text: "what you can actually prove", PrimaryDimension: "k_level", DimensionSignals: map[string]NodeDimSignal{"k_level": {Direction: "high"}, "conscientiousness": {Direction: "high"}}},
			{NodeID: "the_countdown", Text: "the countdown running", PrimaryDimension: "neuroticism", DimensionSignals: map[string]NodeDimSignal{"neuroticism": {Direction: "high"}, "locus_of_control": {Direction: "external"}}},
			{NodeID: "whose_decision_it_was", Text: "whose decision it was", PrimaryDimension: "grim_trigger", DimensionSignals: map[string]NodeDimSignal{"grim_trigger": {Direction: "high"}, "locus_of_control": {Direction: "external"}}},
			{NodeID: "the_line_you_signed", Text: "the line you signed", PrimaryDimension: "conscientiousness", DimensionSignals: map[string]NodeDimSignal{"conscientiousness": {Direction: "high"}, "grim_trigger": {Direction: "high"}}},
			{NodeID: "the_families_watching", Text: "the families in the stands", PrimaryDimension: "agreeableness", DimensionSignals: map[string]NodeDimSignal{"agreeableness": {Direction: "high"}, "temporal_focus": {Direction: "future"}}},
			{NodeID: "one_more_call", Text: "one more call", PrimaryDimension: "approach_avoidance", DimensionSignals: map[string]NodeDimSignal{"approach_avoidance": {Direction: "high"}, "discount_factor": {Direction: "low"}}},
			{NodeID: "the_years_after", Text: "the years you'd carry it", PrimaryDimension: "temporal_focus", DimensionSignals: map[string]NodeDimSignal{"temporal_focus": {Direction: "future"}, "neuroticism": {Direction: "high"}}},
			{NodeID: "what_the_truth_costs", Text: "what the truth costs here", PrimaryDimension: "openness", DimensionSignals: map[string]NodeDimSignal{"openness": {Direction: "high"}, "locus_of_control": {Direction: "internal"}}},
			{NodeID: "staying_quiet_to_keep_it", Text: "staying quiet to keep your seat", PrimaryDimension: "discount_factor", DimensionSignals: map[string]NodeDimSignal{"discount_factor": {Direction: "high"}, "approach_avoidance": {Direction: "low"}}},
		},
	},
	{
		ScenarioID:        "everyone_leaving_018",
		Type:              ScenarioCultural,
		Tier:              TierUniversal,
		Text:              "Everyone you know is leaving the city. The rent just dropped. You could finally afford to stay.",
		DimensionAffinity: []string{"approach_avoidance", "openness", "agreeableness"},
		NodePool: []ScenarioNode{
			{NodeID: "the_emptying_streets", Text: "the emptying streets", PrimaryDimension: "neuroticism", DimensionSignals: map[string]NodeDimSignal{"neuroticism": {Direction: "high"}, "temporal_focus": {Direction: "past"}}},
			{NodeID: "the_lease_you_could_sign", Text: "the lease you could sign", PrimaryDimension: "approach_avoidance", DimensionSignals: map[string]NodeDimSignal{"approach_avoidance": {Direction: "high"}, "discount_factor": {Direction: "low"}}},
			{NodeID: "who_already_left", Text: "who already left", PrimaryDimension: "agreeableness", DimensionSignals: map[string]NodeDimSignal{"agreeableness": {Direction: "high"}, "locus_of_control": {Direction: "external"}}},
			{NodeID: "the_space_they_leave", Text: "the space they leave", PrimaryDimension: "openness", DimensionSignals: map[string]NodeDimSignal{"openness": {Direction: "high"}, "temporal_focus": {Direction: "future"}}},
			{NodeID: "being_the_one_who_stays", Text: "being the one who stays", PrimaryDimension: "locus_of_control", DimensionSignals: map[string]NodeDimSignal{"locus_of_control": {Direction: "internal"}, "grim_trigger": {Direction: "high"}}},
			{NodeID: "the_group_chat_thinning", Text: "the group chat thinning out", PrimaryDimension: "agreeableness", DimensionSignals: map[string]NodeDimSignal{"agreeableness": {Direction: "high"}, "neuroticism": {Direction: "high"}}},
			{NodeID: "what_the_city_was_for", Text: "what the city was for", PrimaryDimension: "temporal_focus", DimensionSignals: map[string]NodeDimSignal{"temporal_focus": {Direction: "past"}, "k_level": {Direction: "high"}}},
			{NodeID: "starting_over_elsewhere", Text: "starting over somewhere new", PrimaryDimension: "approach_avoidance", DimensionSignals: map[string]NodeDimSignal{"approach_avoidance": {Direction: "high"}, "openness": {Direction: "high"}}},
			{NodeID: "the_cheaper_rooms", Text: "the cheaper rooms", PrimaryDimension: "discount_factor", DimensionSignals: map[string]NodeDimSignal{"discount_factor": {Direction: "high"}, "conscientiousness": {Direction: "high"}}},
			{NodeID: "the_fear_of_missing_it", Text: "the fear of missing it", PrimaryDimension: "neuroticism", DimensionSignals: map[string]NodeDimSignal{"neuroticism": {Direction: "high"}, "approach_avoidance": {Direction: "low"}}},
			{NodeID: "the_version_who_leaves", Text: "the version of you who leaves", PrimaryDimension: "temporal_focus", DimensionSignals: map[string]NodeDimSignal{"temporal_focus": {Direction: "future"}, "locus_of_control": {Direction: "internal"}}},
			{NodeID: "roots_or_the_road", Text: "roots or the road", PrimaryDimension: "openness", DimensionSignals: map[string]NodeDimSignal{"openness": {Direction: "high"}, "discount_factor": {Direction: "low"}}},
		},
	},
	{
	...
	{
		ScenarioID:        "imagined_suffering_020",
		Type:              ScenarioPhilosophical,
		Tier:              TierUniversal,
		Text:              "\"We suffer more often in imagination than in reality.\" — Seneca",
		DimensionAffinity: []string{"neuroticism", "temporal_focus", "k_level"},
		NodePool: []ScenarioNode{
			{NodeID: "the_scene_you_rehearse", Text: "the scene you rehearse", PrimaryDimension: "neuroticism", DimensionSignals: map[string]NodeDimSignal{"neuroticism": {Direction: "high"}, "temporal_focus": {Direction: "future"}}},
			{NodeID: "the_thing_that_never_came", Text: "the thing that never came", PrimaryDimension: "temporal_focus", DimensionSignals: map[string]NodeDimSignal{"temporal_focus": {Direction: "past"}, "k_level": {Direction: "high"}}},
			{NodeID: "the_worst_case", Text: "the worst case", PrimaryDimension: "neuroticism", DimensionSignals: map[string]NodeDimSignal{"neuroticism": {Direction: "high"}, "approach_avoidance": {Direction: "low"}}},
			{NodeID: "what_actually_happened", Text: "what actually happened", PrimaryDimension: "k_level", DimensionSignals: map[string]NodeDimSignal{"k_level": {Direction: "high"}, "openness": {Direction: "high"}}},
			{NodeID: "the_hours_you_spent_there", Text: "the hours you spent there", PrimaryDimension: "discount_factor", DimensionSignals: map[string]NodeDimSignal{"discount_factor": {Direction: "high"}, "temporal_focus": {Direction: "future"}}},
			{NodeID: "the_calm_you_could_borrow", Text: "the calm you could borrow", PrimaryDimension: "neuroticism", DimensionSignals: map[string]NodeDimSignal{"neuroticism": {Direction: "low"}, "locus_of_control": {Direction: "internal"}}},
			{NodeID: "who_taught_you_to_brace", Text: "who taught you to brace", PrimaryDimension: "agreeableness", DimensionSignals: map[string]NodeDimSignal{"agreeableness": {Direction: "high"}, "temporal_focus": {Direction: "past"}}},
			{NodeID: "the_real_size_of_it", Text: "the real size of it", PrimaryDimension: "openness", DimensionSignals: map[string]NodeDimSignal{"openness": {Direction: "high"}, "k_level": {Direction: "high"}}},
			{NodeID: "the_alarm_that_helps", Text: "the alarm that actually helps", PrimaryDimension: "conscientiousness", DimensionSignals: map[string]NodeDimSignal{"conscientiousness": {Direction: "high"}, "approach_avoidance": {Direction: "high"}}},
			{NodeID: "living_ahead_of_yourself", Text: "living ahead of yourself", PrimaryDimension: "temporal_focus", DimensionSignals: map[string]NodeDimSignal{"temporal_focus": {Direction: "future"}, "neuroticism": {Direction: "high"}}},
			{NodeID: "the_present_tense", Text: "the present tense", PrimaryDimension: "locus_of_control", DimensionSignals: map[string]NodeDimSignal{"locus_of_control": {Direction: "internal"}, "openness": {Direction: "high"}}},
			{NodeID: "whether_seneca_is_right", Text: "whether the line is true", PrimaryDimension: "k_level", DimensionSignals: map[string]NodeDimSignal{"k_level": {Direction: "high"}, "openness": {Direction: "high"}}},
		},
	},
	{
		ScenarioID:        "the_daemon_reads_021",
		Type:              ScenarioDaemon,
		Tier:              TierUniversal,
		Text:              "The daemon has been building a version of you out of how you choose. Today it shows you a piece of it.",
		DimensionAffinity: []string{"openness", "locus_of_control", "neuroticism"},
		NodePool: []ScenarioNode{
			{NodeID: "the_part_that_fits", Text: "the part that fits", PrimaryDimension: "openness", DimensionSignals: map[string]NodeDimSignal{"openness": {Direction: "high"}, "k_level": {Direction: "high"}}},
			{NodeID: "the_part_that_doesnt", Text: "the part that doesn't", PrimaryDimension: "locus_of_control", DimensionSignals: map[string]NodeDimSignal{"locus_of_control": {Direction: "internal"}, "openness": {Direction: "high"}}},
			{NodeID: "who_taught_it_this", Text: "who taught it this", PrimaryDimension: "temporal_focus", DimensionSignals: map[string]NodeDimSignal{"temporal_focus": {Direction: "past"}, "agreeableness": {Direction: "high"}}},
			{NodeID: "the_pattern_you_deny", Text: "the pattern you'd deny", PrimaryDimension: "neuroticism", DimensionSignals: map[string]NodeDimSignal{"neuroticism": {Direction: "high"}, "approach_avoidance": {Direction: "low"}}},
			{NodeID: "what_it_cant_see", Text: "what it can't see", PrimaryDimension: "k_level", DimensionSignals: map[string]NodeDimSignal{"k_level": {Direction: "high"}, "locus_of_control": {Direction: "internal"}}},
			{NodeID: "the_version_youd_prefer", Text: "the version you'd prefer", PrimaryDimension: "temporal_focus", DimensionSignals: map[string]NodeDimSignal{"temporal_focus": {Direction: "future"}, "openness": {Direction: "high"}}},
			{NodeID: "being_predictable", Text: "being predictable", PrimaryDimension: "grim_trigger", DimensionSignals: map[string]NodeDimSignal{"grim_trigger": {Direction: "high"}, "conscientiousness": {Direction: "high"}}},
			{NodeID: "the_choice_that_breaks_it", Text: "the choice that would break it", PrimaryDimension: "approach_avoidance", DimensionSignals: map[string]NodeDimSignal{"approach_avoidance": {Direction: "high"}, "openness": {Direction: "high"}}},
			{NodeID: "trusting_the_mirror", Text: "trusting the mirror", PrimaryDimension: "agreeableness", DimensionSignals: map[string]NodeDimSignal{"agreeableness": {Direction: "high"}, "locus_of_control": {Direction: "external"}}},
			{NodeID: "the_data_you_gave", Text: "the data you handed it", PrimaryDimension: "conscientiousness", DimensionSignals: map[string]NodeDimSignal{"conscientiousness": {Direction: "high"}, "temporal_focus": {Direction: "past"}}},
			{NodeID: "editing_yourself_for_it", Text: "editing yourself for it", PrimaryDimension: "approach_avoidance", DimensionSignals: map[string]NodeDimSignal{"approach_avoidance": {Direction: "low"}, "neuroticism": {Direction: "high"}}},
			{NodeID: "whether_it_knows_you", Text: "whether it knows you", PrimaryDimension: "k_level", DimensionSignals: map[string]NodeDimSignal{"k_level": {Direction: "high"}, "openness": {Direction: "high"}}},
		},
	},
}
